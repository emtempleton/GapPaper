...
for file in flist:
    ...
    data_connection_S1 = pd.read_csv(os.path.join(base_dir, 'Data', 'continuous_connection_ratings', 'friends', '{}_{}.csv').format(id_1,id_2))
    data_connection_S2 = pd.read_csv(os.path.join(base_dir, 'Data', 'continuous_connection_ratings', 'friends', '{}_{}.csv').format(id_2,id_1))
...
full_df.to_csv(os.path.join(base_dir, 'Analyses',
                            'binned_connection_and_gaps_friends.csv'), encoding='utf-8', index=False)   
