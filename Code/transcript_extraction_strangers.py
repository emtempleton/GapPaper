...
def preprocess_documents(document):
    ...
    in brackets (and the brackets themselves).
...
output_dir = os.path.join(base_dir, 'Analyses', 'turn_taking', 'strangers')
if not os.path.exists(output_dir):
    os.makedirs(output_dir)

flist = glob.glob(os.path.join(base_dir, 'Data', 'transcripts', 'stranger_transcripts', '*.txt'))
