...
flist = glob.glob(os.path.join(base_dir, 'Data', 'continuous_connection_ratings', 'friends', '*.csv'))
...
connection.to_csv(os.path.join(base_dir, 'Analyses', 'connection_friends.csv'), encoding='utf-8', index=False)