...
# Same as bin_connection_and_gaps_friends.py but additionally
...
for file in flist:
    ...
    data_connection_S1 = pd.read_csv(os.path.join(base_dir, 'Data', 'continuous_connection_ratings', 'friends', '{}_{}.csv').format(subID_S1,subID_S2))
    data_connection_S2 = pd.read_csv(os.path.join(base_dir, 'Data', 'continuous_connection_ratings', 'friends', '{}_{}.csv').format(subID_S2,subID_S1))
    ...
    for num_bins in num_bins_list:
        ...
        output_dir = os.path.join(base_dir, 'Analyses', 'binned', 'friends')
        if not os.path.exists(output_dir):
            os.makedirs(output_dir)
...
full_df.to_csv(os.path.join(base_dir, 'Analyses',
                            'binned_connection_and_gaps_by_speaker_friends.csv'), encoding='utf-8', index=False)   
